...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-blue-600 to-blue-800 items-center justify-center">
        <div className="absolute inset-0 bg-black/20"></div>
        <div className="relative z-10 text-center text-white p-12">
          <img 
            src="/company_logo.jpg" 
            alt="Company Logo" 
            className="h-24 w-24 mx-auto mb-8 rounded-lg bg-white/10 p-2"
          />
